...
/// Represents electricity prices for a full day (24 hours).
///
/// Contains a list of hourly electricity prices and provides convenient
/// methods to analyze the price data for the day.
class PriceDay {
  /// The list of electricity prices for this day (typically 24 hours)
  ...
  /// Returns the number of hourly prices in this day.
  ...
  /// Gets the price for the current hour.
  ///
